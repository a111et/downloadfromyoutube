...
Если возникла ошибка с загрузкой, скорее всего, нужно просто обновить [yt-dlp](https://github.com/yt-dlp/yt-dlp/releases)

Если возникла ошибка при загрузке через aria2, попробуйте включить VPN и повторить загрузку.
